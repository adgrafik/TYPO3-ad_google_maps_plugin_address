...
class Tx_AdGoogleMapsPluginAddress_Domain_Model_Address extends Tx_Extbase_DomainObject_AbstractEntity {
	...
	/**
	 * Sets this pluginAddressCoordinates
	 *
	 * @param string $pluginAddressCoordinates
	 * @return void
	 */
	public function setPluginAddressCoordinates($pluginAddressCoordinates) {
		$this->pluginAddressCoordinates = $pluginAddressCoordinates;
	}

	/**
	 * Returns this pluginAddressCoordinates
	 *
	 * @return string
	 */
