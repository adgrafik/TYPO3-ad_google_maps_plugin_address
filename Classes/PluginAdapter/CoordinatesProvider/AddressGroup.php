 ...
 */
class Tx_AdGoogleMapsPluginAddress_PluginAdapter_CoordinatesProvider_AddressGroup extends Tx_AdGoogleMapsPluginAddress_PluginAdapter_CoordinatesProvider_Addresses {
	...
	public function loadAddresses() {
		...
		$this->addresses = (count($result) > 0 ? $addressGroupRepository->getAddressesRecursively($result[0]->getTxAdgooglemapspluginaddressAddressGroups()) : array());
	}
