...
$tempColumns = array(
	'tx_adgooglemapspluginaddress_addresses' => array(
		...
		'displayCond' => 'FIELD:coordinates_provider:=:Tx_AdGoogleMapsPluginAddress_MapManager_CoordinatesProvider_Addresses',
		'config' => array(
			'type' => 'select',
			'size' => '5',
			'autoSizeMax' => 15,
	...
	'tx_adgooglemapspluginaddress_address_groups' => array(
		...
		'exclude' => true,
		'l10n_mode' => $excludeProperties,
		'displayCond' => 'FIELD:coordinates_provider:=:Tx_AdGoogleMapsPluginAddress_MapManager_CoordinatesProvider_AddressGroup',
		'config' => array(
			'type' => 'select',
			'size' => '5',
			'autoSizeMax' => 15,
...
// Add layer type icon.
$TCA['tx_adgooglemaps_domain_model_layer']['columns']['coordinates_provider']['config']['items'][] = array('LLL:EXT:ad_google_maps_plugin_address/Resources/Private/Language/locallang_tca.xml:tx_adgooglemaps_domain_model_layer.coordinatesProvider.addresses', 'Tx_AdGoogleMapsPluginAddress_MapManager_CoordinatesProvider_Addresses');
$TCA['tx_adgooglemaps_domain_model_layer']['columns']['coordinates_provider']['config']['items'][] = array('LLL:EXT:ad_google_maps_plugin_address/Resources/Private/Language/locallang_tca.xml:tx_adgooglemaps_domain_model_layer.coordinatesProvider.addressGroups', 'Tx_AdGoogleMapsPluginAddress_MapManager_CoordinatesProvider_AddressGroup');
